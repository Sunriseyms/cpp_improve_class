...
#ifndef PX_ARM_CPP_PRIMER_CHAPTER_1_LIUXD_VERSION_TEST_H_
#define PX_ARM_CPP_PRIMER_CHAPTER_1_LIUXD_VERSION_TEST_H_

#ifndef PX_ARM_CPP_PRIMER_CHAPTER_1_CAOY_INCLUDE_VERSION_TEST_H_
#define PX_ARM_CPP_PRIMER_CHAPTER_1_CAOY_INCLUDE_VERSION_TEST_H_
...
#ifndef LROUND
inline long lround(double d) { return (d >= 0) ? long(d + 0.5) : long(d - 0.5); }
#endif

#endif  // ends header guard

#endif  // PX_ARM_CPP_PRIMER_CHAPTER_1_CAOY_INCLUDE_VERSION_TEST_H_

#endif  // PX_ARM_CPP_PRIMER_CHAPTER_1_LIUXD_VERSION_TEST_H_
